...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meal', models.CharField(choices=[('BRKF', 'Breakfast'), ('MNSN', 'Morning Snack'), ('LNCH', 'Lunch'), ('SNCK', 'Snack'), ('DNNR', 'Dinner')], max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mealType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Home.meal')),
            ],
        ),
        migrations.CreateModel(
            name='DislikedPost',
